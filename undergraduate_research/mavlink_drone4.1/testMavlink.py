...
class mavlink:
    ...
    def Global_Request(self, data = None):
        self.mavlin.mav.command_long_send(
            self.mavlin.target_system,
            self.mavlin.target_component,
            mavutil.mavlink.MAV_CMD_REQUEST_MESSAGE,
        ...
        self.msg = self.mavlin.recv_match(type = 'GLOBAL_POSITION_INT',blocking=True)
        data[1] = self.msg.lat/10000000
        data[2] = self.msg.lon/10000000
        data[3] = self.msg.alt/100
