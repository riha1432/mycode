...
#define MAVLINK_COMMON_XML_HASH -9121679614986320377
...
typedef enum MAV_MODE
{
   ...
   MAV_MODE_MANUAL_DISARMEDlo=64, /* System is allowed to be active, under manual (RC) control, no stabilization | */
